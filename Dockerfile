...
RUN cd /home/steam/ && curl -s https://steamcdn-a.akamaihd.net/client/installer/steamcmd_linux.tar.gz | tar -vxz
RUN cp -f linux64/steamclient.so /home/steam/.steam/sdk64/steamclient.so
